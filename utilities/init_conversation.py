...
You will need to provide the other party's name, identity key, handshake
key, and ratchet key. Conversations are identified by your name and the
other person's name. Each conversation should have a unique other person's
name. Your name can be the same for each conversation or different for each
...
if ans == 'y':
    ...
    a.saveState()
    print('The conversation ' + your_name + ' -> ' +
          other_name + ' has been saved.')
else:
